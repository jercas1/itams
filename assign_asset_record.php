  ...
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content">
        ...
        <div class="container">
          ...
          <div class="row g-2 mb-5">
            ...
            <div class="row mb-3 mt-4">
                <div class="col-3">
                    <label for="search_employee" class="form-label" >Search Employee</label>
                </div>
                <div class="col-9">
                    <input type="text" class="form-control" id="search_employee"  placeholder="search employee details" required>
                </div>
            </div>
            <div class="row">
                <div class="col">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-danger" onclick="">Add Asset</button>
...
$(document).ready(function(){
    ...
    assign_emp_record();
    record_list()
	$('#search_asset_record').keypress(function(){
		var search = $(this).val().toUpperCase();
		if(search != '')
		{
			assign_asset_record(search);
		}
		else
		{
			assign_asset_record();			
    ...
    $('#search_employee').keypress(function(){
		var search_id = $(this).val().toUpperCase();
		if(search_id != '')
		{
			assign_emp_record(search_id);
		}
		else
		{
			assign_emp_record();			
