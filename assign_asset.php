  ...
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="container">            
          ...
          <div class="row g-2 mb-5">
            ...
            <div class="row mt-5">
                <div class="col">
                    <label for="new_asset_tag" class="form-label" >Employees ID</label>
                    <input type="text" class="form-control" id="emp_id"  placeholder="" required>
                </div>
                <div class="col">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-danger" onclick="addmultiasset()">Add Asset</button>
        <button type="button" class="btn btn-primary" onclick="submit_assignasset()">Submit</button>
      </div>
    </div>
  </div>
</div>
