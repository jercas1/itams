    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="container">
          ...
          <div class="row g-2 mb-3">
            <div class="col-5 needs-validaton" id="val_asset" novalidation>
            ...
            <div class="col-2 needs-validaton" id="val_type" novalidation>
              <label for="new_type" class="form-label">Type</label>
              <input type="text" class="form-control" id="new_type" placeholder="e.g. laptop" required>
                <div class="valid-feedback">Looks good!</div>
                <div class="invalid-feedback">This field is required!</div>
            </div>
          </div>
